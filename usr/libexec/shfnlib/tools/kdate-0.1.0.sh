...
setarray monthname jan feb mar apr may jun jul aug sep oct nov dec
setarray dayname sun mon tue wed thu fri sat
...
echo "$gl_outyear $gl_outmonth $gl_outday $gl_outtday $gl_outwday $gl_inhour $gl_inmin $gl_insec $((gl_inhour * 60 * 60 + gl_inmin * 60 + gl_insec)) ${monthname[$((gl_outmonth - 1))]} ${dayname[gl_outwday]}"
